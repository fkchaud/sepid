...
UserProfile.create! [
  { name: 'Investigador', access: {'Administrar usuarios' => {'Asignar perfil' => false,
                                    ...
                                    'Administrar Pedidos de cambio de Inciso' => {'Aprobar cambio de inciso' => false,
                                                                                  'Rechazar cambio de inciso' => false},
                                    'Generar reportes' => {'Realizar reporte' => false},
                                    'Administrar Cargo Universitario' => {'Agregar cargo universitario' => false,
                                                                          'Editar cargo universitario' => false,
                                                                          'Eliminar cargo universitario' => false},
                                    'Administrar Estado de Proyecto' => {'Agregar estado de proyecto' => false,
                                                                         'Editar estado de proyecto' => false,
                                                                         'Eliminar estado de proyecto' => false},
                                    'Administrar Tipo de Proyecto' => {'Agregar tipo de proyecto' => false,
                                                                       'Editar tipo de proyecto' => false,
                                                                       'Eliminar tipo de proyecto' => false},
                                    'Administrar Tipo de Resolución' => {'Agregar tipo de resolución' => false,
                                                                         'Editar tipo de resolución' => false,
                                                                         'Eliminar tipo de resolución' => false},
                                    'Parametrizar Tipo de Pedido' => {'Agregar tipo de pedido' => false,
                                                                      'Editar tipo de pedido' => false,
                                                                      'Eliminar tipo de pedido' => false,
                                                                      'Editar atributos' => false},
                                    'Administrar Inciso' => {'Agregar inciso' => false,
                                                             'Editar inciso' => false,
                                                             'Eliminar inciso' => false},
                                    'Administrar Estado de Cambio de Inciso' => {'Agregar estado de cambio de inciso' => false,
                                                                                 'Editar estado de cambio de inciso' => false,
                                                                                 'Eliminar estado de cambio de inciso' => false},
                                    'Administrar Estado del Pedido' => {'Agregar estado de pedido' => false,
                                                                        'Editar estado de pedido' => false,
                                                                        'Eliminar estado de pedido' => false},
                                    'Administrar Estado de Valor' => {'Agregar estado de valor' => false,
                                                                      'Editar estado de valor' => false,
                                                                      'Eliminar estado de valor' => false},
                                    'Back up' => {'Realizar backup' => false}}},
  { name: 'Super_Admin', access: {'Administrar usuarios' => {'Asignar perfil' => true,
                                                             'Agregar usuario' => true,
                                                             'Editar usuario' => true,
                                                             'Eliminar usuario' => true,
                                                             'Asignar cargo universitario' => true},
                                  'Administrar perfil de usuario' => {'Asignar permisos'=> true,
                                                                      'Agregar perfil' => true,
                                                                      'Editar perfil' => true,
                                                                      'Eliminar perfil' => true},
                                  'Administrar proyectos' => {'Agregar proyecto' => true,
                                                              'Consultar gastos' => true,
                                                              'Editar proyecto' => true,
                                                              'Cancelar proyecto' => true,
                                                              'Solicitar cambio de inciso' => true,
                                                              'Realizar pedido' => true},
                                  'Administrar pedidos' => {'Ajustar preventivo' => true,
                                                            'Ver cambios de estado' => true,
                                                            'Aprobar pedido' => true,
                                  ...
                                  'Administrar Pedidos de cambio de Inciso' => {'Aprobar cambio de inciso' => true,
                                                                                'Rechazar cambio de inciso' => true},
                                  'Generar reportes' => {'Realizar reporte' => true},
                                  'Administrar Cargo Universitario' => {'Agregar cargo universitario' => true,
                                                                        'Editar cargo universitario' => true,
                                                                        'Eliminar cargo universitario' => true},
                                  'Administrar Estado de Proyecto' => {'Agregar estado de proyecto' => true,
                                                                       'Editar estado de proyecto' => true,
                                                                       'Eliminar estado de proyecto' => true},
                                  'Administrar Tipo de Proyecto' => {'Agregar tipo de proyecto' => true,
                                                                     'Editar tipo de proyecto' => true,
                                                                     'Eliminar tipo de proyecto' => true},
                                  'Administrar Tipo de Resolución' => {'Agregar tipo de resolución' => true,
                                                                       'Editar tipo de resolución' => true,
                                                                       'Eliminar tipo de resolución' => true},
                                  'Parametrizar Tipo de Pedido' => {'Agregar tipo de pedido' => true,
                                                                    'Editar tipo de pedido' => true,
                                                                    'Eliminar tipo de pedido' => true,
                                                                    'Editar atributos' => true},
                                  'Administrar Inciso' => {'Agregar inciso' => true,
                                                           'Editar inciso' => true,
                                                           'Eliminar inciso' => true},
                                  'Administrar Estado de Cambio de Inciso' => {'Agregar estado de cambio de inciso' => true,
                                                                               'Editar estado de cambio de inciso' => true,
                                                                               'Eliminar estado de cambio de inciso' => true},
                                  'Administrar Estado del Pedido' => {'Agregar estado de pedido' => true,
                                                                      'Editar estado de pedido' => true,
                                                                      'Eliminar estado de pedido' => true},
                                  'Administrar Estado de Valor' => {'Agregar estado de valor' => true,
                                                                    'Editar estado de valor' => true,
                                                                    'Eliminar estado de valor' => true},
                                  'Back up' => {'Realizar backup' => true}}},
  { name: 'DEF_Admin', access: {'Administrar usuarios' => {'Asignar perfil' => false,
                                                           'Agregar usuario' => false,
                                                           'Editar usuario' => true,
                                                           'Eliminar usuario' => false,
                                                           'Asignar cargo universitario' => false},
                                ...
                                'Administrar Estado de Valor' => {'Agregar estado de valor' => false,
                                                                  ...
                                                                  'Eliminar estado de valor' => false},
                                'Back up' => {'Realizar backup' => false}}},
  { name: 'SeCYT_Sec', access: {'Administrar usuarios' => {'Asignar perfil' => false,
                                                           'Agregar usuario' => false,
                                                           'Editar usuario' => true,
                                                           'Eliminar usuario' => false,
                                                           'Asignar cargo universitario' => false},
                                ...
                                'Administrar Estado de Valor' => {'Agregar estado de valor' => false,
                                                                  ...
                                                                  'Eliminar estado de valor' => false},
                                'Back up' => {'Realizar backup' => false}}},
  { name: 'SeCYT_Admin', access: {'Administrar usuarios' => {'Asignar perfil' => true,
                                                             'Agregar usuario' => true,
                                                             'Editar usuario' => true,
                                                             'Eliminar usuario' => true,
                                                             'Asignar cargo universitario' => true},
